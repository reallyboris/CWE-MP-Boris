...
country = {
	...
	GOLD_TO_CASH_RATE = 2, -- Amount of money generated per gold unit
	GOLD_TO_WORKER_PAY_RATE = 1.2, -- Multiplier for how much money gold pays to pops
	...
	BUREAUCRACY_PERCENTAGE_INCREMENT = 0.003, -- For each social administrative reform level, this is added to MAX_BUREAUCRACY_PERCENTAGE
	...
	PROVINCE_OVERSEAS_PENALTY = 0.5, -- Each province req. this many goods flagged as overseas penalty 
	...
	INVESTMENT_SCORE_FACTOR = 0.002, -- how much foreign investment money counts towards your industry score originally 0.005
...
economy = {
    ...
    CAPITALIST_BUILD_FACTORY_STATE_EMPLOYMENT_PERCENT = 0.5, -- Capis don't build factories if less than this percent is employed in existing factories
    ...
    FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.95, -- % of how much we pay to the pops and capitalists, from the leftovers.
    ...
    TRADE_CAP_LOW_LIMIT_LAND = 0.08,                 -- the lowest % the slider can go for land units
