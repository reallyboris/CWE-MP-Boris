...
country = {
	...
	GOLD_TO_CASH_RATE = 13, -- Amount of money generated per gold unit
	GOLD_TO_WORKER_PAY_RATE = 0.8, -- Multiplier for how much money gold pays to pops
	...
	AI_SUPPORT_REFORM = 0.10, -- At least this many % needs to support a reform for the AI to take it
	BASE_MONTHLY_DIPLOPOINTS = 0.3, -- Base value gain for diplomatic actions each month
	DIPLOMAT_TRAVEL_TIME = -1,
	PROVINCE_OVERSEAS_PENALTY = 0.2, -- Each province req. this many goods flagged as overseas penalty 
	NONCORE_TAX_PENALTY = -0.1, -- -5% for each non-core in state
	BASE_TARIFF_EFFICIENCY = 0.25, -- baseline tariff efficiency -- TODO
	...
	WRONG_REFORM_MILITANCY_IMPACT = 5,
	SUPPRESSION_RADICALISATION_HIT = 10, -- % base added to a movements radicalness
	INVESTMENT_SCORE_FACTOR = 0.010, -- how much foreign investment money counts towards your industry score
	UNCIV_TECH_SPREAD_MAX = 0.30,
	UNCIV_TECH_SPREAD_MIN = 0.30,
	MIN_DELAY_BETWEEN_REFORMS = 6, -- months -- TODO
	ECONOMIC_REFORM_UH_FACTOR = -0.2,
	MILITARY_REFORM_UH_FACTOR = -0.2,
	WRONG_REFORM_RADICAL_IMPACT = 25,
	TECH_YEAR_SPAN = 140,
	TECH_FACTOR_VASSAL = 0.75, -- cost reduction factor if overlord has research the tech
	MAX_SUPPRESSION = 100,
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 20, -- TODO base value that is powered by level of naval base. Determines the naval supplying capabilities. 
	...
	COLONIZATION_RELEASE_DOMINION_COST = 10,
...
economy = {
    ...
    GOODS_FOCUS_SWAP_CHANCE = 0.05, -- Percent increased chance that artisan wants to change goods independently of how well he is doing presently
    NUM_CLOSED_FACTORIES_PER_STATE_LASSIEZ_FAIRE = 7, -- Number of closed factories allowed per state under Lassiez Faire
    MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 7, -- Min number of factories per state before starting to delete under Lassiez Faire
    BANKRUPCY_DURATION = 10, -- Years till a bankruptcy clears all loans
    ...
    TRADE_CAP_LOW_LIMIT_NAVAL = 0.9,             -- the lowest % the slider can go for naval units
    ...
    FACTORY_PURCHASE_DRAWDOWN_FACTOR = 0.04    -- the % a factory will reduce its input purchases each day if it did not sell all its goods (also used for scaling up production if all goods are sold)
},
...
military = {
    ...
    POP_MIN_SIZE_FOR_REGIMENT = 2000,
    POP_SIZE_PER_REGIMENT = 6000,
    SOLDIER_TO_POP_DAMAGE = 0.17,
    ...
    SIEGE_BRIGADES_MAX = 15, -- the number of brigades above which you get no addition benefit in sieges
    ...
    BASE_MILITARY_TACTICS = 1.0, -- base mil tactics before tech
    NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.9, -- how little supply is acceptable before getting damage to STR
...
diplomacy = {
	...
	REMOVEFROMSPHERE_INFAMY_COST = 0.1, -- only applied if removing country is sphere leader
	...
	LONE_BACKER_PRESTIGE_FACTOR = 0.02 -- prestige boost for being only defender backer in crisis
},  
...
ai = {
    ...
    ADMINISTRATOR_WEIGHT = 20.0, -- ai weight for new bureaucrat
    ...
    CAPITALIST_FRACTION = 0.005, -- max amount of population AI wants to be capis
...
graphics =
{
	...
	CITIES_SIZE_MAX_POPULATION_K = 4000 -- TODO			-- When province population reach 1mln, the city will get it's maximum size.
}
