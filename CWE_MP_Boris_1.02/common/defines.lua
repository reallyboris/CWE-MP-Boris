...
country = {
	...
	PROVINCE_OVERSEAS_PENALTY = 0.075, -- Each province req. this many goods flagged as overseas penalty 
...
ai = {
    ...
    CAPITALIST_FRACTION = 0.000, -- max amount of population AI wants to be capis
